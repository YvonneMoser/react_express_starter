                ...
                <label className="font-weight-normal">
                  ...
                  <span className="no-button-style">
                    ...
                    <span className="info-span">
                      ...
                      Betrag. Der Anteil der Zinsen vs. Tilgung ist anfangs
                      größer und sinkt mit der Zeit.
                    </span>
                  </span>
                </label>
              </div>
                ...
                <label className="font-weight-normal">
                  ...
                  <span className="no-button-style">
                    ...
                    <span className="info-span">
                      ...
                      Bankverbindlichkeit (Zins + Tilgung) und
                      nicht-umlagefähige Nebenkosten bezahlt sind bleibt dieser
                      Betrag übrig. Ist er negativ, muss der Vermieter monatlich
                      nachschießen. Ist er positiv, so generiert das Objekt auch
                      nach Tilgung einen Überschuss (cashflow-positiv).
                    </span>
                  </span>
                </label>
              </div>
                ...
                <label className="font-weight-normal">
                  ...
                  <span className="no-button-style">
                    ...
                    <span className="info-span">
                      ...
                      damit ihren steuerlichen Gewinn zu senken. Hierbei darf
                      der anteilige Wert des Gebäudes über 50 Jahre linear
                      ...
                      derzeit circa bei 30% zu 70%. In schlechteren Lagen und
                      bei Neubauten ist der Gebäudeanteil entsprechend höher.
                      Der AfA-Satz bei Baujahren vor 1925 beträgt ferner 2,5%.
                      Weitere Infos hierzu ergeben sich aus der Arbeits­hil­fe
                      zur Auf­tei­lung ei­nes Ge­samt­kauf­prei­ses für ein
                      be­bau­tes Grund­stück des Finanzministeriums.
                    </span>
                  </span>
                </label>
              </div>
              ...
              <div className="info-icon-container-2">
                <label className="font-weight-normal">
                  ...
                  <span className="no-button-style">
                    ⓘ{" "}
                    <span className="info-span">
                      Hier wird angenommen, dass sich der Zins nicht verändert.
                      In der Praxis sind es meist 10 Jahre Sollzinsbindung, d.h.
                      nach 10 Jahren wird mit neuen Konditionen die Restschuld
